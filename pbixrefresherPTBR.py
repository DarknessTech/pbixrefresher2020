...
def main():   
	...
	parser.add_argument("--workspace", help = "name of online Power BI service work space to publish in", default = "Meu workspace")
	...
	print("Aguardando ",INIT_WAIT,"sec")
	time.sleep(INIT_WAIT)

	# Connect pywinauto
	print("Identificando a Janela do Power BI")
	...
	# Atualizando
	print("Atualizando")
	win.Atualizar.click_input()
	win.wait("enabled", timeout = 300)
	time.sleep(5)
	print("Aguardando atualização e (timeout in ", REFRESH_TIMEOUT,"sec)")
	win.wait("enabled", timeout = REFRESH_TIMEOUT)

	# Publish
	if args.publish:
		print("Salvando e Publicando")
		win.Publicar.click_input()
		time.sleep(10)
		save_dialog = win.child_window(auto_id = "modalDialog")
		save_dialog.Salvar.click_input()
		time.sleep(10)
		...
		time.sleep(10)
		publish_dialog.Selecionar.click_input()
		time.sleep(10)
		replace_dialog = win.child_window(auto_id = "KoPublishWithImpactViewDialog")
		replace_dialog.Substituir.click_input()
		time.sleep(10)
		entendi_dialog = win.child_window(auto_id = "KoPublishDialog")
		entendi_dialog.Entendi.click_input()
		time.sleep(10)
